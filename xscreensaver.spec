...
Source0  : https://www.jwz.org/xscreensaver/xscreensaver-6.06.tar.gz
...
%prep
%setup -q -n xscreensaver-6.06
cd %{_builddir}/xscreensaver-6.06
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674262490
