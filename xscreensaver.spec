...
Source0  : https://www.jwz.org/xscreensaver/xscreensaver-6.01.tar.gz
...
%prep
%setup -q -n xscreensaver-6.01
cd %{_builddir}/xscreensaver-6.01
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624514515
